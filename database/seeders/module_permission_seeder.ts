    ...
    try {
      const modules = [
        ...
        { id: 4, key: 'clients', name: 'Clientes', description: 'Gestión de Clientes' },
        {
          ...
          description: 'Solicitudes de Clientes',
        },
        ...
        { id: 19, key: 'rols', name: 'Roles', description: 'Gestión de Roles y Permisos' },
        {
          ...
          description: 'Movimientos de ingreso y egreso',
        },
        {
          id: 21,
          key: 'service_entry_sheets',
      ...
      const permissions = [
        ...
        },
        {
          ...
          description: 'Gestionar empleados de empresas',
          type: 'business',
          moduleId: 2,
        },
        {
          key: 'manageSalaries',
          name: 'Gestionar Salarios',
          description: 'Gestionar salarios de empresas',
          type: 'business',
          moduleId: 2,
        },
        ...
        },
        {
          key: 'managePermits',
          name: 'Gestionar Permisos',
          description: 'Gestionar permisos de empleados',
          type: 'employees',
          moduleId: 3,
        },
        {
          ...
          description: 'Gestionar licencias de empleados',
          type: 'employees',
          moduleId: 3,
        },
        {
          key: 'manageAccess',
          name: 'Gestionar Acceso',
          description: 'Gestionar acceso de empleados',
          type: 'employees',
          moduleId: 3,
        },
        {
          key: 'viewReports',
          name: 'Ver Reportes',
          description: 'Ver reportes de empleados',
          type: 'employees',
          moduleId: 3,
        },
        ...
        // Client Requests module (5)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver solicitudes de clientes',
          type: 'clientRequests',
          moduleId: 5,
        },
        {
          key: 'create',
          name: 'Crear',
          description: 'Crear solicitudes de clientes',
          type: 'clientRequests',
          moduleId: 5,
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar solicitudes de clientes',
          type: 'clientRequests',
          moduleId: 5,
        },
        {
          key: 'delete',
          name: 'Eliminar',
          description: 'Eliminar solicitudes de clientes',
          type: 'clientRequests',
          moduleId: 5,
        },
        ...
        // Bugets/Quotes module (6)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver presupuestos/cotizaciones',
          type: 'bugets',
          moduleId: 6,
        },
        {
          key: 'create',
          name: 'Crear',
          description: 'Crear presupuestos/cotizaciones',
          type: 'bugets',
          moduleId: 6,
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar presupuestos/cotizaciones',
          type: 'bugets',
          moduleId: 6,
        },
        {
          key: 'delete',
          name: 'Eliminar',
          description: 'Eliminar presupuestos/cotizaciones',
          type: 'bugets',
          moduleId: 6,
        },
        {
          key: 'search',
          name: 'Buscar',
          description: 'Buscar presupuestos/cotizaciones',
          type: 'bugets',
          moduleId: 6,
        },
        {
          key: 'viewReports',
          name: 'Ver Reportes',
          description: 'Ver reportes de presupuestos',
          type: 'bugets',
          moduleId: 6,
        },
        ...
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar órdenes de compra',
          type: 'shopping',
          moduleId: 7,
        },
        {
        ...
        },
        {
          key: 'authorize',
          name: 'Autorizar',
          description: 'Autorizar órdenes de compra',
          type: 'shopping',
          moduleId: 7,
        },
        {
          key: 'share',
          name: 'Compartir',
          description: 'Compartir órdenes de compra',
          type: 'shopping',
          moduleId: 7,
        },
        ...
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar bBookings',
          type: 'booking',
          moduleId: 8,
        },
        {
          key: 'delete',
          name: 'Eliminar',
          description: 'Eliminar bBookings',
          type: 'booking',
          moduleId: 8,
        },
        {
          key: 'search',
          name: 'Buscar',
          description: 'Buscar bBookings',
          type: 'booking',
          moduleId: 8,
        },
        {
          key: 'manageComplements',
          name: 'Gestionar Complementos',
          description: 'Gestionar complementos de reservas',
          type: 'booking',
          moduleId: 8,
        },
        ...
        {
          key: 'managePhotos',
          name: 'Gestionar Fotos',
          description: 'Gestionar fotos de productos',
          type: 'products',
          moduleId: 9,
        },
        ...
        },
        {
          ...
          description: 'Gestionar productos de proveedores',
          type: 'providers',
          moduleId: 10,
        },
        ...
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar cuentas bancarias',
          type: 'banks',
          moduleId: 11,
        },
        {
        ...
        { key: 'create', name: 'Crear', description: 'Crear monedas', type: 'coins', moduleId: 12 },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar monedas',
          type: 'coins',
          moduleId: 12,
        },
        {
        ...
        // Works/Projects module (13)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver trabajos/proyectos',
          type: 'works',
          moduleId: 13,
        },
        {
          key: 'create',
          name: 'Crear',
          description: 'Crear trabajos/proyectos',
          type: 'works',
          moduleId: 13,
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar trabajos/proyectos',
          type: 'works',
          moduleId: 13,
        },
        {
          key: 'delete',
          name: 'Eliminar',
          description: 'Eliminar trabajos/proyectos',
          type: 'works',
          moduleId: 13,
        },
        ...
        // Cost Centers module (14)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver centros de costo',
          type: 'costCenters',
          moduleId: 14,
        },
        {
          key: 'create',
          name: 'Crear',
          description: 'Crear centros de costo',
          type: 'costCenters',
          moduleId: 14,
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar centros de costo',
          type: 'costCenters',
          moduleId: 14,
        },
        {
          key: 'delete',
          name: 'Eliminar',
          description: 'Eliminar centros de costo',
          type: 'costCenters',
          moduleId: 14,
        },
        ...
        {
          key: 'bookingItems',
          name: 'Items de Reserva',
          description: 'Gestionar configuraciones de items de reserva',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'bookingProperties',
          name: 'Propiedades de Reserva',
          description: 'Gestionar configuraciones de propiedades de reserva',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'bookingNotes',
          name: 'Notas de Reserva',
          description: 'Gestionar configuraciones de notas de reserva',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'budgetCategories',
          name: 'Categorías de Presupuesto',
          description: 'Gestionar configuraciones de categorías de presupuesto',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'budgetItems',
          name: 'Items de Presupuesto',
          description: 'Gestionar configuraciones de items de presupuesto',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'isapres',
          name: 'Isapres',
          description: 'Gestionar configuraciones de isapres',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'discounts',
          name: 'Descuentos',
          description: 'Gestionar configuraciones de descuentos',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'assets',
          name: 'Activos',
          description: 'Gestionar configuraciones de activos',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'afp',
          name: 'AFP',
          description: 'Gestionar configuraciones de AFP',
          type: 'settings',
          moduleId: 18,
        },
        {
          ...
          description: 'Gestionar configuraciones de tipos de contrato',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'affiliations',
          name: 'Afiliaciones',
          description: 'Gestionar configuraciones de afiliaciones',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'loadFamily',
          name: 'Carga Familiar',
          description: 'Gestionar configuraciones de carga familiar',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'layoff',
          name: 'Despido',
          description: 'Gestionar configuraciones de despido',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'exregime',
          name: 'Ex-Régimen',
          description: 'Gestionar configuraciones de ex-régimen',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'certificateHealthItems',
          name: 'Items de Certificado de Salud',
          description: 'Gestionar configuraciones de items de certificado de salud',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'legalGratifications',
          name: 'Gratificaciones Legales',
          description: 'Gestionar configuraciones de gratificaciones legales',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'schedules',
          name: 'Horarios',
          description: 'Gestionar configuraciones de horarios',
          type: 'settings',
          moduleId: 18,
        },
        {
          key: 'licenses',
          name: 'Licencias',
          description: 'Gestionar configuraciones de licencias',
          type: 'settings',
          moduleId: 18,
        },
        ...
        // Balances module (20)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver movimientos de ingresos y egresos',
          type: 'balances',
          moduleId: 20,
        },

        // Service Entry Sheets module (21)
        {
          key: 'view',
          name: 'Ver',
          description: 'Ver hojas de entrada de servicios',
        ...
        },
        {
          key: 'create',
          name: 'Crear',
          description: 'Crear hojas de entrada de servicios',
          type: 'service_entry_sheets',
          moduleId: 21,
        },
        {
          key: 'update',
          name: 'Actualizar',
          description: 'Actualizar hojas de entrada de servicios',
          type: 'service_entry_sheets',
          moduleId: 21,
        },
        {
      ...
      for (const permission of permissions) {
        await Permission.updateOrCreate(
          { key: permission.key, moduleId: permission.moduleId },
          permission,
          { client: trx }
        )
      }
