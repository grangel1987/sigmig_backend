...
export default class SettingAsset extends BaseModel {
    ...
    @column()
    public tributable: boolean

    @column()
    public gratifying: boolean
    ...
    @beforeCreate()
    public static async setEnabled(model: SettingAsset) {
        model.enabled = true
    }
