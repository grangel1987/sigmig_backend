...
export default class SettingLicCompensationBox extends BaseModel {
    @column({ isPrimary: true })
    public id: number

    @column()
    public name: string // Inferred; adjust if different
    ...
    @beforeCreate()
    public static async setEnabled(model: SettingLicCompensationBox) {
        model.enabled = true
    }
