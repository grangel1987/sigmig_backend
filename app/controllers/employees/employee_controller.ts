    ...
    public async show({ params }: HttpContext) {
        ...
        const employee = await Employee.query()
            ...
            .preload('business', (b) => {
                ...
                b.preload('afp2')
                b.preload('exRegime')
                b.preload('typeContract')
                b.preload('affiliation')
                b.preload('layoff')
                b.preload('isapre')
                b.preload('loadFamily')
                b.preload('remunerationType')
                b.preload('legalGratification')
                b.preload('bank')
                b.preload('typeAccount')
                b.preload('costCenter')
                b.preload('ahorroCoin')
                b.preload('healthPactCoin')
                b.preload('inactiveByUser')
                b.preload('position', (bb) => bb.select(['id', 'name']))
            })
