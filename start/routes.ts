  ...
  .group(() => {
    router
      .group(() => {
        ...
        router.post(
          ...
          '#controllers/users/user_controller.changePasswordForgot'
        )
        ...
        router
          .group(() => {
            ...
            router.post(
              '/change-password',
              '#controllers/users/user_controller.changePasswordOwner'
            )
            router.post(
              '/assign-to-employee',
              '#controllers/users/user_controller.assignUserToEmployee'
            )
            router.post(
              '/remove-from-employee',
              '#controllers/users/user_controller.removeUserFromEmployee'
            )
            ...
            router.get(
              '/find/permission/:module_id',
              '#controllers/users/user_controller.findPermission'
            )
            ...
            router.post(
              '/code/confirm/verify',
              '#controllers/users/user_controller.verifyCodeConfirm'
            )
            ...
            router.post(
              ...
              '#controllers/users/user_controller.adminResetPassword'
            )
          })
          .middleware(auth)
    ...
    router
      .group(() => {
        router.get(
          '/country/web/:id',
          '#controllers/settings/setting_controller.findSettingsByCountry'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/cost_centers/cost_center_controller.changeStatus'
        )
        ...
        router.get(
          '/find-all/:business_id',
          '#controllers/cost_centers/cost_center_controller.findAll'
        )
        router.get(
          '/select/:business_id',
          '#controllers/cost_centers/cost_center_controller.select'
        )
      })
      .prefix('cost-center')
      .middleware(auth)
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/booking/setting_booking_item_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.get(
          '/find-by-type/:id',
          '#controllers/buget/setting_buget_item_controller.findByType'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/booking/setting_booking_note_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/discount/setting_discount_controller.changeStatus'
        )
      })
    ...
    router
      .group(() => {
        ...
        router.put(
          '/update/:type_id',
          '#controllers/type_contract/setting_type_contract_controller.update'
        )
        router.put(
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/affiliation/setting_affiliation_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/load_family/setting_load_family_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/layoff/setting_layoff_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/exregime/setting_ex_regime_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        router.get(
          '/',
          '#controllers/certificate_health_item/setting_certificate_health_item_controller.index'
        )
        router.put(
          '/update/:id',
          '#controllers/certificate_health_item/setting_certificate_health_item_controller.update'
        )
        router.put(
          '/change-status/:id',
        ...
        router.post(
          '/store',
          '#controllers/certificate_health_item/setting_certificate_health_item_controller.store'
        )
        router.get(
          '/select',
          '#controllers/certificate_health_item/setting_certificate_health_item_controller.select'
        )
      })
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/business/business_salary_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.post(
          '/findAutoComplete',
          '#controllers/products/product_controller.findAutoComplete'
        )
    ...
    router
      .group(() => {
        ...
        router.get(
          '/find/products/:provider_id',
          '#controllers/provider/provider_controller.findProductsByProvider'
        )
        router.post('/product/store', '#controllers/provider/provider_controller.storeProduct')
        router.put(
          '/product/update/:product_id',
          '#controllers/provider/provider_controller.updateProduct'
        )
        router.put(
          '/product/change-status/:product_id',
          '#controllers/provider/provider_controller.changeStatusProduct'
        )
        router.post(
          '/find/autocomplete',
          '#controllers/provider/provider_controller.findAutoComplete'
        )
        router.post(
          '/product/find/autocomplete',
          '#controllers/provider/provider_controller.findProductAutoComplete'
        )
        router.get(
          '/product/show/:product_id',
          '#controllers/provider/provider_controller.showProduct'
        )
      })
      .prefix(`provider`)
      .middleware(auth)
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_work_activity_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_occupation_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_paying_entity_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_type_license_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/update/:id',
          '#controllers/setting_lics/lic_compensation_box_controller.update'
        )
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_compensation_box_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/lic_mutual_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/setting_lics/setting_lic_motive_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        ...
        router.put(
          '/change-status/:id',
          '#controllers/schedules/setting_schedule_controller.changeStatus'
        )
    ...
    router
      .group(() => {
        router.get(
          '/',
          '#controllers/legal_gratifications/setting_legal_gratification_controller.index'
        )
        router.post(
          '/store',
          '#controllers/legal_gratifications/setting_legal_gratification_controller.store'
        )
        router.put(
          '/update/:id',
          '#controllers/legal_gratifications/setting_legal_gratification_controller.update'
        )
        router.put(
          '/change-status/:id',
          '#controllers/legal_gratifications/setting_legal_gratification_controller.changeStatus'
        )
        router.get(
          '/select',
          '#controllers/legal_gratifications/setting_legal_gratification_controller.select'
        )
      })
      .prefix('setting-legal-gratification')
      .middleware(auth)
    ...
    router
      .group(() => {
        router.post(
          '/business/change',
          '#controllers/business/business_employee_controller.changeBusiness'
        )
        router.post(
          '/business/add-other',
          '#controllers/business/business_employee_controller.addOtherBusiness'
        )
      })
      .prefix('business-employee')
      .middleware(auth)
    ...
    router
      .group(() => {
        ...
        router.post(
          '/find-by-identify',
          '#controllers/employees/employee_controller.findByIdentify'
        )
        ...
        router.post(
          '/find-by-last-name-p',
          '#controllers/employees/employee_controller.findByLastNameP'
        )
        router.put('/delete/photo', '#controllers/employees/employee_controller.deletePhoto')
        router.get(
          '/count/active/:business_id',
          '#controllers/employees/employee_controller.countActive'
        )
        ...
        router.post(
          '/find/autocomplete',
          '#controllers/employees/employee_controller.findAutocomplete'
        )
        ...
        router.put(
          '/permits/update',
          '#controllers/employees/employee_controller.updateWorkPermits'
        )
        router.post(
          '/permits/authorize',
          '#controllers/employees/employee_controller.autorizePermit'
        )
        router.post(
          '/permits/delete-file',
          '#controllers/employees/employee_controller.deleteFilePermit'
        )
        router.post(
          '/permits/delete-all',
          '#controllers/employees/employee_controller.deletePermit'
        )
        router.post(
          '/find/license-health',
          '#controllers/employees/employee_controller.findLicensesHealth'
        )
        router.post(
          '/store/license-health',
          '#controllers/employees/employee_controller.storeLicenseHealth'
        )
        router.put(
          '/update/license-health/:id',
          '#controllers/employees/employee_controller.updateLicenseHealth'
        )
        router.delete(
          '/delete/license-health/:id',
          '#controllers/employees/employee_controller.deleteLicenseHealth'
        )
        router.post('/access/find', '#controllers/employees/employee_controller.findAccess')
        router.post(
          '/access/find-by-empployee',
          '#controllers/employees/employee_controller.findAccessByEmployeeId'
        )
      })
      .prefix('employee')
      .middleware(auth)
    ...
    router
      .group(() => {
        router.get(
          '/permits/find-by-token/:token',
          '#controllers/employees/employee_controller.showWorkPermitByToken'
        )
      })
      .prefix('employee')
    ...
    router
      .group(() => {
        ...
        router.post(
          '/find-by-token',
          '#controllers/client_requests/client_request_controller.findByToken'
        )
        router.post(
          '/find-by-client',
          '#controllers/client_requests/client_request_controller.findRequestByClientId'
        )
      })
    ...
    router
      .group(() => {
        ...
        router.get(
          '/count/made/year/:business_id',
          '#controllers/bugets/buget_controller.countMadeYear'
        )
      ...
      .group(() => {
        ...
        router
          .group(() => {
            ...
            router.put(
              '/update/:id',
              '#controllers/ledging_accounts/ledging_account_controller.update'
            )
            router.delete(
              '/delete/:id',
              '#controllers/ledging_accounts/ledging_account_controller.delete'
            )
        ...
        router
          .group(() => {
            ...
            router.put(
              '/update/:id',
              '#controllers/payment_methods/payment_method_controller.update'
            )
            router.delete(
              '/delete/:id',
              '#controllers/payment_methods/payment_method_controller.delete'
            )
        ...
        router
          .group(() => {
            router.get(
              '/',
              '#controllers/payment_document_types/payment_document_type_controller.index'
            )
            router.post(
              '/store',
              '#controllers/payment_document_types/payment_document_type_controller.store'
            )
            router.get(
              '/show/:id',
              '#controllers/payment_document_types/payment_document_type_controller.show'
            )
            router.put(
              '/update/:id',
              '#controllers/payment_document_types/payment_document_type_controller.update'
            )
            router.delete(
              '/delete/:id',
              '#controllers/payment_document_types/payment_document_type_controller.delete'
            )
            router.get(
              '/select',
              '#controllers/payment_document_types/payment_document_type_controller.select'
            )
          })
    ...
    router
      .group(() => {
        ...
        router.put(
          '/update/nro-buget/:id',
          '#controllers/shoppings/shopping_controller.updateNroBuget'
        )
    ...
    router
      .group(() => {
        router.get(
          '/view/:token/observations',
          '#controllers/bugets/buget_controller.listObservationsPublic'
        )
        router.post(
          '/:token/observations',
          '#controllers/bugets/buget_controller.addObservationFromClient'
        )
    ...
    router
      .group(() => {
        ...
        router.post('/view/:token/share', '#controllers/bugets/budget_edps_controller.shareByToken')
      })
      .prefix('edps')
    ...
    router
      .group(() => {
        ...
        router.post(
          '/count/unattended',
          '#controllers/booking/booking_controller.findCountUnattended'
        )
      ...
      .group(() => {
        ...
        router
          .group(() => {
            router.post(
              '/metrics',
              '#controllers/dashboard/dashboard_controller.purchaseOrdersMetrics'
            )
            router.post(
              '/pending',
              '#controllers/dashboard/dashboard_controller.pendingPurchaseOrders'
            )
          })
          .prefix('shoppings')
    ...
    router
      .group(() => {
        ...
        router.post(
          '/types/store',
          '#controllers/notifications/notification_types_controller.store'
        )
        router.put(
          '/types/update/:id',
          '#controllers/notifications/notification_types_controller.update'
        )
        router.post(
          '/types/:id/assign',
          '#controllers/notifications/notification_types_controller.assignUserNotificationTypes'
        )
